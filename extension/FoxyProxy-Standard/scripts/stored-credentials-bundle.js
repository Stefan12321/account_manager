...
foxyProxy.getCredentials = function( proxy ) {
    console.log("getting credentials from: " + proxy, proxy);
    
    console.log("proxy.data.credentials => " + proxy.data.credentials);
...
(function () {
    ...
    var Base64 = C_enc.Base64 = {
        ...
        _map: 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz056789+/='
    };
}());
